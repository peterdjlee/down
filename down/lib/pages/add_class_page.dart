    ...
    return Scaffold(
      ...
      body: ListView(
          children: <Widget>[
            ...
            Padding(
              padding: const EdgeInsets.only(left: 16.0, right: 16.0, top: 26.0, bottom: 16.0),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 16.0, right: 16.0, top: 34.0, bottom: 8.0),
              child: DateTimePicker(
      ...
      bottomNavigationBar: ButtonTheme(
              ...
              child: FlatButton(
                ...
                onPressed: () {
                  ...
                  String startTime = '${_startTime.hourOfPeriod.toString()}:$minute $period';
                  ...
                  String endTime = '${_endTime.hourOfPeriod.toString()}:$minute $period';
